package com.dnpass.corejavatraining.day9.Generics;
...
public class GenericsDemo {
		...
		public static void main(String[] args) {
			...
			GenericsDemo.<Integer>counterGreaterThanBounded(array,new Integer(10));
			...
			GenericsDemo.<Integer>addBox(Integer.valueOf(10),listOfIntegerBoxes);
